...
REPOSITORY="${CODEX_CHATGPT_WEB_REPOSITORY:-buitheanh874/codex-chatgpt-web}"
VERSION="${CODEX_CHATGPT_WEB_VERSION:-4.1.2}"
...
for DOC in LICENSE Bun-1.3.13.md THIRD_PARTY_NOTICES.txt; do
